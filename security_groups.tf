...
resource "aws_security_group_rule" "http" {
  ...
  description       = "Permitir conexiones al puerto 80 desde cualquier IP"
...
resource "aws_security_group_rule" "http2" {
  ...
  ipv6_cidr_blocks  = ["::/0"]
  security_group_id = aws_security_group.servidor_web.id
  description       = "Permitir conexiones al puerto 8080 desde cualquier IP"
...
resource "aws_security_group_rule" "https" {
  ...
  ipv6_cidr_blocks  = ["::/0"]
  security_group_id = aws_security_group.servidor_web.id
  description       = "Permitir conexiones al puerto 443 desde cualquier IP"
